...
- `1` Complete.
  - Evidence captured:
    - 3-day TestFlight/Sentry launch + crash-free baseline confirmed against thresholds in `apps/mobile/TESTFLIGHT_BETA_RUNBOOK.md` (operator validation complete).
- `2` Complete.
...
- Phase 2.5 exit criteria are complete; proceed with Phase 2.6 native-first execution slices.
